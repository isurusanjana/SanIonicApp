...
/**
 * Generated class for the SurveyReportAddPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-survey-report-add',
  templateUrl: 'survey-report-add.html',
})
export class SurveyReportAddPage {
  ...
  doSubmit()
  {
    if(this.storageData.remaining_free_reports >=1 || this.storageData.remaining_credit_reports >=1 ) {
      let data: any = {
        'reported_by': this.surveyForm.value.reported_by,
        'date_time': this.surveyForm.value.date_time,
        'label1': this.surveyForm.value.label1,
        'value1': this.surveyForm.value.value1,
        'label2': this.surveyForm.value.label2,
        'value2': this.surveyForm.value.value2,
        'label3': this.surveyForm.value.label3,
        'value3': this.surveyForm.value.value3,
        'address': this.surveyForm.value.address,
        'latitude': this.surveyForm.value.latitude,
        'longitude': this.surveyForm.value.longitude,
        'details': this.surveyForm.value.details,
        'description-image1': this.surveyForm.value.description_image1,
        'description-image2': this.surveyForm.value.description_image2,
        'description-image3': this.surveyForm.value.description_image3,
        'description-image4': this.surveyForm.value.description_image4,
        'image1': this.image1,
        'image2': this.image2,
        'image3': this.image3,
        'image4': this.image4,
      ...
      this.api.postData('survey_report', data).then((res: any) => {
        ...
        let alert = this.alertCtrl.create({
          ...
          message: "You have successfully created Survey Report..",
          buttons: [
            {
              text: 'OK',
              role: 'cancel',
